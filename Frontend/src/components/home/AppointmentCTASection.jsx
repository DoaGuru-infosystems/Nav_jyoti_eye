...
import doctorImg from '../../assets/images/home/AppointmentCTASection.png';
			...
			<div className="container">
				<div className="row justify-between">
					...
					<div className="lg:w-1/3 w-full self-end">
						<div className="lg:-mt-20 ltr:xl:-me-32.5 ltr:lg:-me-6.25 rtl:3xl:-me-32.5 rtl:lg:-me-6.25 lg:-ms-7.5 max-lg:text-center relative after:absolute after:top-2/5 ltr:after:left-0 rtl:after:right-0 after:size-full after:bg-no-repeat after:bg-pointed-arrow wow fadeInUp" data-wow-delay="1.0s" data-wow-duration="0.8s">
							<img src={ ctaImg || "https://images.pexels.com/photos/33812025/pexels-photo-33812025.jpeg?auto=compress&cs=tinysrgb&w=580&h=570&fit=crop" } alt="Doctor" className="w-[90%] xl:w-[85%] mx-auto lg:ms-auto lg:me-0" />
						</div>
					</div>
				</div>
			</div>
