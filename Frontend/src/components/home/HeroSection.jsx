					...
					<div className="row items-center h-full">
						<div className="lg:w-5/12 w-full mb-7.5 lg:order-1 order-2">
							<div className="2xxl:ps-25 2xxl:ms-0 xxl:ms-10 xl:ms-7.5 max-sm:text-center">
								...
								<div className="flex flex-row items-center gap-3 sm:gap-7.5 max-sm:justify-center wow fadeInUp" data-wow-delay="0.8s">
									<a href="/appointment" className="btn btn-primary max-sm:px-3 max-sm:py-2.5 max-sm:text-xs">
										Appointment
										<i className="feather icon-arrow-right ltr:ml-1 rtl:mr-1"></i>
									</a>
									<a href="/eye-care-videos" className="flex relative z-1 items-center text-lg font-medium leading-[1.3] before:top-0 ltr:before:left-0 rtl:before:right-0 before:absolute before:size-12.5 max-sm:before:size-10 before:rounded-2lg before:bg-transparent before:-z-1 before:duration-200 hover:before:bg-primary hover:before:w-full group">
										<i className="icon feather icon-play inline-block w-10 h-12.5 max-sm:w-8 max-sm:h-10 min-w-10 max-sm:min-w-8 rounded-6xl !leading-12.5 max-sm:!leading-10 align-center text-primary text-xl max-sm:text-sm me-2.5 max-sm:me-1.5 px-5 max-sm:px-2.5 duration-200 group-hover:text-white"></i>
										<span className="text-lg max-sm:text-xs font-medium pe-7.5 max-sm:pe-2 text-secondary duration-200 group-hover:text-white whitespace-nowrap">Watch Highlight</span>
									</a>
								</div>
							</div>
						</div>
						<div className="lg:w-7/12 w-full self-end wow fadeInRight lg:order-2 order-1" data-wow-delay="0.8s" data-wow-duration="0.8s">
							<div className="relative w-full lg:w-[53vw] lg:float-end 3xl:ms-25 lg:ms-auto" data-bottom-top="transform: translateY(-50px)" data-top-bottom="transform: translateY(50px)">
