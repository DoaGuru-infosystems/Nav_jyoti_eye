				...
				<div className="row content-wrapper style-42 mb-7.5 justify-center">
					<div className="lg:w-1/2 w-full">
						<div className="relative z-1 xl:pe-27.5 sm:pe-12.5 mb-7.5">
							...
							<div className="absolute z-10 -top-10 ltr:sm:right-25 ltr:right-0 rtl:sm:left-25 rtl:left-0" data-bottom-top="transform: translateY(-30px)" data-top-bottom="transform: translateY(30px)">
								<a href="#" onClick={ e => e.preventDefault() }>
									<div className="flex items-center justify-center">
										<span className="word-rotate-box light flex justify-center items-center xl:size-45 lg:size-37.5 size-30 bg-transparent rounded-full text-center p-3.75 relative after:absolute after:top-0 ltr:after:left-0 rtl:after:right-0 after:size-full after:-z-1 after:rounded-full after:border-[25px] after:border-transparent after:backdrop-blur-[17px] after:bg-primary after:drop-shadow-[0px_0px_100px_rgba(0,0,0,0.15)]">
