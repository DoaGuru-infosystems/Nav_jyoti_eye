...
export default function FaqSection({ className = '' }) {
  const faqImg = ""; // "/assets/images/about/img2.webp"
					...
					<div className="xl:w-1/2 w-full xl:order-1 order-2">
						<div className="relative">
							<div className="relative z-1 2xl:-ms-25 max-md:px-7.5">
								<img src={faqImg || "https://images.pexels.com/photos/8459996/pexels-photo-8459996.jpeg?auto=compress&cs=tinysrgb&w=740&h=705&fit=crop"} alt="" className="rtl:rotate-y-180" />
							</div>
						</div>
					</div>
						...
						<div className="content-info right">
							...
							<div className="myAccordion style-3 wow fadeInUp" data-wow-delay="0.4s" data-wow-duration="0.8s" id="accordionExample">
								...
								<div key={faq.id} className="accordion-item">
									...
									<div className={`accordion-content ${openId === faq.id ? 'show' : ''}`} style={{ display: openId === faq.id ? 'block' : 'none' }}>
