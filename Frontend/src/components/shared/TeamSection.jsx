...
import imgDr from "../../assets/images/home/doctor.png";
                        ...
                        <div key={ index } className="xl:w-1/3 sm:w-1/2 w-full mb-7.5 wow fadeInUp" data-wow-delay={ `${0.2 + (index * 0.1)}s` } data-wow-duration="0.8s">
                            <div className="bg-light rounded-2xl overflow-hidden box-hover active h-full flex flex-col">
                                <div className="relative overflow-hidden">
                                    <img src={ imgDr || "https://images.pexels.com/photos/5327921/pexels-photo-5327921.jpeg?auto=compress&cs=tinysrgb&w=600&h=600&fit=crop" } alt={ member.name } className="w-full h-80 object-cover object-top" />
                                </div>
