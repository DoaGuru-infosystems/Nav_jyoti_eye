...
export default function ScrollToTop() {
  return (
    <button
      id="scrollProgress"
      title="Scroll to top"
      className="scroll-top fixed z-[9999] left-5 bottom-5 size-12.5 rounded-full bg-secondary text-white cursor-pointer opacity-0 pointer-events-none duration-500 flex items-center justify-center [.scroll-top.active]:opacity-100 [.scroll-top.active]:pointer-events-auto max-sm:hidden"
    >
