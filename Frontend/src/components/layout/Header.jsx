        ...
        <div className="container-fluid flex 3xl:px-20! xl:px-12.5! md:px-7.5! px-3.75!">
          ...
          <div className="flex lg:basis-auto lg:grow max-lg:flex-col justify-start max-lg:fixed max-lg:h-screen max-lg:px-5 max-lg:top-0 ltr:max-lg:-left-75 rtl:max-lg:-right-75 max-lg:z-9999 max-lg:bg-white max-lg:w-72 max-lg:overflow-auto max-lg:duration-700 header-nav custom-scroll">
            ...
            <div className="flex items-center relative z-9 py-6.25 lg:hidden w-33.75 h-15.25">
              <Link to="/" className="table-cell align-middle">
                <img src="/assets/images/logo.svg" alt="ClinicMaster" className="object-contain duration-500" />
              </Link>
            </div>
            ...
            <div className="lg:hidden block max-lg:p-5 text-center mt-auto">
              <ul>
                <li className="inline-block mx-0.5">
                  <a className="size-10 !leading-10 border border-black/10 text-center text-primary fab fa-facebook-f" target="_blank" rel="noreferrer" href="https://www.facebook.com/dexignzone" aria-label="Facebook" />
                </li>
                <li className="inline-block mx-0.5">
                  <a className="size-10 !leading-10 border border-black/10 text-center text-primary fa-brands fa-x-twitter" target="_blank" rel="noreferrer" href="https://twitter.com/dexignzones" aria-label="Twitter/X" />
                </li>
                <li className="inline-block mx-0.5">
                  <a className="size-10 !leading-10 border border-black/10 text-center text-primary fab fa-linkedin-in" target="_blank" rel="noreferrer" href="https://www.linkedin.com/showcase/3686700/admin/" aria-label="LinkedIn" />
                </li>
                <li className="inline-block mx-0.5">
                  <a className="size-10 !leading-10 border border-black/10 text-center text-primary fab fa-instagram" target="_blank" rel="noreferrer" href="https://www.instagram.com/dexignzone/" aria-label="Instagram" />
                </li>
              </ul>
            </div>
          </div>
