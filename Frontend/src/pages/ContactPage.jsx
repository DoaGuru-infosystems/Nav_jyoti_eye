...
import ContactBG from '../assets/images/navjyoti/ContactBG.png';
import Contactform from '../assets/images/navjyoti/Contactform.png';
...
export default function ContactPage() {
	...
	return (
		<>
			<div className="2xxl:min-h-125 lg:min-h-112.5 md:min-h-full sm:min-h-87.5 min-h-75 bg-cover bg-center bg-light relative z-1 w-full overflow-hidden pb-7.5 before:absolute ltr:before:left-0 rtl:before:right-0 before:top-0 before:size-full before:bg-primary before:opacity-70" style={ { backgroundImage: `url(${ContactBG})` } }>
				<div className="container relative z-1 h-full table">
					<div className="table-cell 2xxl:h-125 lg:h-112.5 md:h-95 sm:h-87.5 h-75 align-middle pt-22.5 pb-5 text-center">
						...
						<nav className="wow fadeInUp" data-wow-delay="0.4s" data-wozw-duration="0.8s">
